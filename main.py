...
def parse_args(args: List[str] = None) -> argparse.Namespace:
    ...
    train_parser.add_argument("--config", type=str, default="config/rl_params.yaml",
                             help="Path to RL configuration file")
    train_parser.add_argument("--sim-config", type=str, default="config/simulation_params.yaml",
